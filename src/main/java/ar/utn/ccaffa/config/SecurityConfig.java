    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST,"/api/ordenes-trabajo").hasAnyAuthority("produccion")
                ...
                .requestMatchers("/api/planner/**").hasAnyAuthority("produccion")
                .requestMatchers("/api/controles-calidad/**").hasAnyAuthority("operario","calidad", "admin")
                .requestMatchers(HttpMethod.POST, "/api/certificados").hasAnyAuthority("operario","calidad")
