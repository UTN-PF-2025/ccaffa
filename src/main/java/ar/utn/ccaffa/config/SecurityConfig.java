    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET,"/api/ordenes-trabajo").hasAnyAuthority("supervisor", "operario","produccion", "deposito", "vendedor")
                ...
                .requestMatchers(HttpMethod.POST, "/api/certificados").hasAuthority("operario")
